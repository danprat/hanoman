...
- Update `internal/docs` yang tersentuh dalam commit yang sama (ADR-0038 sudah ditulis di fase spec; api-contract.md + frontend-implementation.md di Task 7).
...
// SPEC-199 · satu WebSocket siar untuk seluruh data real-time dashboard (ADR-0038). Meniru
...
// SPEC-199 · WebSocket siar dashboard (ADR-0038). Auth diwarisi gate onRequest scope /api
...
WebSocket siar `GET /events/ws` (SPEC-199, ADR-0038) — bukan lagi polling. Terminal PTY punya
