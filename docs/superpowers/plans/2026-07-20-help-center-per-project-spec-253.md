...
- ADR baru = **ADR-0062** (tertinggi saat ini 0060; tak ada collision lintas branch).
...
- Docs: `internal/docs/adr/0062-help-center-tiket-publik-triase.md` (BARU) + update `data-model.md`, `api-contract.md`, `security-standard.md`, `frontend-implementation.md`, `README.md`
...
git commit -m "feat(spec-253): triage UI + HelpCenterCard + notifikasi ticket + docs SoT/ADR-0062"
```
