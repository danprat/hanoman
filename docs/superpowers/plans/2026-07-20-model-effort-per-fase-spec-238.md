...
- Sesi tetap **satu proses `claude`** — TIDAK ada respawn per fase (ADR-0057/0024/0015).
...
// tak berubah). Ganti model aman terhadap konteks; `/effort` best-effort di Opus/Fable (ADR-0057).
