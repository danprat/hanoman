...
- **BARU** `internal/docs/adr/0062-help-center-tiket-publik-triase.md` — model baru + kolom Project
...
- `README.md` index — link ADR-0062 (dan pastikan doc lain tetap ter-link).
...
8. **Docs SoT + ADR-0062** — semua doc di atas, ter-link di index (boleh menyebar di tiap PR yang
