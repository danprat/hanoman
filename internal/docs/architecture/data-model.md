...
Center** (`Ticket`, `TicketAttachment`, SPEC-253/[ADR-0061](../adr/0061-help-center-tiket-publik-triase.md)).
...
- `helpEnabled` (Boolean, default false · SPEC-253 · [ADR-0061](../adr/0061-help-center-tiket-publik-triase.md)) —
...
- `id` (SPEC-n), `projectId`, `title`, `source` ("brief" | "qa" | "audit" | "help")
  - **`help`** (SPEC-253/[ADR-0061](../adr/0061-help-center-tiket-publik-triase.md)): backlog hasil
...
## Ticket / TicketAttachment (SPEC-253 · [ADR-0061](../adr/0061-help-center-tiket-publik-triase.md))
...
- Submit publik `POST /api/help/:slug/tickets` (multipart) diotorisasi **`Project.helpEnabled`**; cek status
  `GET /api/help/:slug/tickets/:key` diotorisasi **kunci opaque** — pengecualian sah gate `/api` (ADR-0061).
