...
- **Audit lintas project** (SPEC-337/ADR-0074): flow `cross-audit` — satu sesi mengaudit project utama
  **+ tetangga `ProjectLink`-nya** (relasi berarah `from → to`, satu hop, kedua arah). Pipeline & deliverable
  ...
  tanpa Spec/fase). Agennya **hanoman sendiri** — bukan agent token eksternal (ADR-0065).
