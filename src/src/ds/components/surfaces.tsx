...
type CardProps = { children?: React.ReactNode; title?: React.ReactNode; eyebrow?: React.ReactNode;
  ...
  interactive?: boolean; padding?: number; style?: React.CSSProperties } & Record<string, any>;
export function Card({ children, title, eyebrow, actions, footer, elevation = "raised", interactive = false,
  padding = 20, className = "", style = {}, ...rest }: CardProps) {
  ...
  return React.createElement("div", _extends({
    ...
    children && React.createElement("div", { style: { padding: hasHeader ? `12px ${padding}px ${padding}px` : padding } }, children),
